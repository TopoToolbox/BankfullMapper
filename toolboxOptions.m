function opts = toolboxOptions
    ...
    identifier = "59752628-c533-4eca-b994-67698c111624";

    opts = matlab.addons.toolbox.ToolboxOptions(toolbox_folder,identifier);

    opts.ToolboxName = "BankfullMapper";
    ...
    opts.OutputFile = fullfile("release","BankfullMapper");
    ...
    opts.AuthorName = 'Michele Delchiaro';

    opts.AuthorEmail = 'michele.delchiaro@uniroma1.it';
    ...
    % absolute path.
    %
    opts.ToolboxImageFile = "images" + filesep + "bankfull_map.png";
